...
def update_or_creat_user_tokens(session_id, access_token, token_type, expires_in, refresh_token):
...
def refresh_spotify_token(session_id):
    tokens = get_user_tokens(session_id).refresh_token
